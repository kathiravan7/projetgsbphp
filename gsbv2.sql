...
--
-- Host: localhost
-- Generation Time: May 01, 2017 at 03:55 PM
...
('a17', '201704', 0, '0.00', '2017-04-17', 'CR');
...
INSERT INTO `translate` (`id`, `fr`, `en`, `es`) VALUES
(1, 'Bonjour', 'Hello', 'Hola'),
(2, 'Connexion', 'Login', 'Conexión'),
(3, 'Mot de passe', 'Password', 'Contraseña'),
(4, 'Valider', 'Submit', 'Validar'),
(5, 'Annuler', 'Cancel', 'Anular'),
(6, 'Identification utilisateur', 'User Identification', ''),
(7, 'Visiteur', 'Visitor', ''),
(8, 'Saisir fiche de frais', 'Input expense report', ''),
(9, 'Mes fiches de frais', 'My expenses', ''),
(10, 'Ajouter un nouveau frais hors forfait', 'Add new out package expense', ''),
(11, 'Date du frais', 'Expense date', ''),
(12, 'Description du fais', 'Expense description', ''),
(13, 'Intranet du Laboratoire Galaxy Swiss Bourdin', 'Galaxy Swiss Bourdin Intranet''s Lab', ''),
(14, 'Suivi du remboursement des frais', 'Expense reimbursement follow-up', ''),
(15, 'Fiche de frais du mois', 'Monthly expense form', ''),
(16, 'Etat', 'State', ''),
(17, 'depuis le ', 'since', ''),
(18, 'Montant validé', 'Amount submitted', ''),
(19, 'Eléments forfaitisés', 'Forfeited elements', ''),
(20, 'Déscriptif des élements hors forfait', 'Out package elements description', ''),
(21, 'Date', 'Date', ''),
(22, 'Libellé', 'Label', ''),
(23, 'Montant', 'Amount', ''),
(24, 'Nouvel élement hors forfait', 'New Out package element', ''),
(25, 'Date (jj/mm/aaaa)', 'Date (yyyy/mm/dd)', ''),
(26, 'Mois à sélectionner', 'Month to select', ''),
(27, 'Montant engage', 'Amount committed', ''),
(28, 'Justificatif ', 'Proof', ''),
(29, 'Déconnexion', 'Logout', ''),
(31, 'Renseigner ma fiche de frais du mois', 'Fill my monthly expense form', ''),
(32, 'Ajouter', 'Add', ''),
(33, 'Effacer', 'Delete', ''),
(34, 'Mois', 'Month\r\n', ''),
(35, 'justificatifs reçus', 'receipt', ''),
(36, 'Forfait Etape', 'Step Package', ''),
(37, 'Frais Kilométrique', 'Kilometers', ''),
(38, 'Nuitée Hotel', 'Bed Night', ''),
(39, 'Repas Restaurant', 'Meal', ''),
(40, 'Saisie clôturée', 'Entry closed', ''),
(41, 'Fiche créee, saisie en cours', 'form created, entry in progress', ''),
(42, 'Remboursée', 'Refund', ''),
(43, 'Validée et mise en paiement', 'Validated and paid', '');
